...
const EducationPage: React.FC = () => {
  const education = {
    ...
    specialization: "Double Major: AI & Data Science", // Updated specialization
    institution: "Assiut National University", // Updated university
    location: "Assiut, Egypt", // Updated location
    period: "2023 - 2027",
    gpa: "Very good",
    // honors: "Magna Cum Laude", // Removed honors if not applicable
  };
      ...
      <div className="pt-32 pb-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <div className="bg-card-bg rounded-lg border border-card-border overflow-hidden max-w-4xl mx-auto">
              {/* Header Section */}
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-center">
                <GraduationCap size={40} className="text-blue-400-foreground mx-auto mb-3" />
                <h2 className="text-2xl font-bold text-blue-400-foreground mb-2">
                  Formal Education
                </h2>
                <div className="flex items-center justify-center text-blue-100 dark:text-blue-200"> {/* Adjusted text color slightly */}
              ...
              <div className="p-6">
                <div className="text-center mb-6">
                  ...
                  {/* GPA Card */}
                  <div className="inline-block bg-card-secondary-bg rounded-lg p-3 border border-card-border"> {/* Use background and card-border */}
          ...
          >
            <div className="flex items-center mb-8">
              <Award size={32} className="text-blue-400 mr-4" />
                ...
                >
                  <div className="flex items-center mb-4">
                    <div className="bg-blue-500 p-2 rounded-lg mr-3">
                      <Award size={20} className="text-blue-400-foreground" />
                    </div>
                    <div>
